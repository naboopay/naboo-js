...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NabooApiV1.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new NabooApiV1.ValidationErrorLocInner();
      //expect(instance).to.be.a(NabooApiV1.ValidationErrorLocInner);
    });
